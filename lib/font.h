...
//Faixas de valores válidos de resistores E24
static uint32_t res_val[56] = {
    510, 560, 620, 680, 750, 820, 910, 1e3, 1.1e3, 1.2e3,
    1.3e3, 1.5e3, 1.6e3, 1.8e3, 2e3, 2.2e3, 2.4e3, 2.7e3,
    3e3, 3.3e3, 3.6e3, 3.9e3, 4.3e3, 4.7e3, 5.1e3, 5.6e3,
    6.2e3, 6.8e3, 7.5e3, 8.2e3, 9.1e3, 1e4, 1.1e4, 1.2e4,
    1.4, 1.5e4, 1.6e4, 1.8e4, 2e4, 2.2e4, 2.4e4, 2.7e4,
    3e4, 3.3e4, 3.6e4, 3.9e4, 4.3e4, 4.7e4, 5.1e4, 5.6e4,
    6.2e4, 6.8e4, 7.5e4, 8.2e4, 9.1e4, 10e4
  };